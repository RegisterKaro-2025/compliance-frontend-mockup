            ...
            <Card>
              <CardContent>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                  ...
                  <Typography variant="body2" color="textSecondary">
                    Click any entity to view detailed information
                  </Typography>
                </Box>
                    ...
                    return (
                      <Grid item xs={12} sm={6} md={4} key={entity.id}>
                        <Card
                          ...
                          onClick={() => navigate(`/entities/${entity.id}/details`)}
                        >
                          <CardContent>
                            ...
                            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                              ...
                              <Button
                                ...
                                onClick={(e) => {
                                  e.stopPropagation();
                                  navigate(`/entities/${entity.id}/details`);
                                }}
                                sx={{ minWidth: 'auto' }}
                              >
                                View Details
      ...
      <Box>
        <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
          ...
          <Typography
            ...
            onClick={() => navigate(`/entities/${selectedEntity.id}/details`)}
          >
            {selectedEntity.name}
          </Typography>
          <Button
