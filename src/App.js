...
// Entity Pages
import EntityDetailsView from './pages/entities/EntityDetailsView';
import EntityDetailsViewTest from './pages/entities/EntityDetailsViewTest';
    ...
    <>
      ...
      <Routes>
        ...
        <Route element={
          ...
          <Route path="/meetings/dashboard" element={<MeetingDashboard />} />
          
          {/* Entity Details */}
          <Route path="/entities/:entityId/details" element={<EntityDetailsView />} />
